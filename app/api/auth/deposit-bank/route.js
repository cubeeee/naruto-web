...
// Tạo đơn nạp ticket qua Pay2s (chuyển khoản VND / VietQR). Trả về thông tin bank + vietqr_url + order_id.
// Credit ticket chỉ xảy ra khi tiền thật về (Pay2s webhook), KHÔNG credit ở bước tạo đơn.
export async function POST(req) {
  ...
  let res;
  try {
    res = await fetch(`${GAME_API_BASE}/ajax/create_deposit.php`, {
      method: "POST",
      headers: {
