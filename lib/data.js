...
export const POSTS = [
  ...
  },
  {
    ...
    cat: "Features",
    tag: "FEATURE",
    title: "VIP & PRIVILEGES - Power Of The Ninja",
    excerpt:
      "Introducing the VIP feature of Nhan Gia Toi Thuong along with a host of exclusive privileges for players.",
    date: "2026-05-13",
    img: "/3.jpg",
  },
  {
    ...
    cat: "News",
    tag: "NEWS",
    title: "BLOCKBUSTER Nhan Gia Toi Thuong LAUNCHES this January!",
    excerpt:
      "Nhan Gia Toi Thuong launches in January - the sacred scroll opens the Three Realms for every ninja.",
    date: "2026-05-12",
    img: "/4.jpg",
    hot: true,
  },
  ...
  },
  {
    ...
    cat: "Guides",
    tag: "GUIDE",
    title: "How To Link Your Account & Play Now",
    excerpt:
      "Link your account in just a few taps to protect your character and receive linking rewards.",
    date: "2026-05-07",
    img: "/3.jpg",
  },
];
...
export const FEATURE_SLIDES = [
  { id: 1, sub: "Log in for rewards", title: "FREE VIP", img: "/1.jpg", tint: "from-amber-600 to-orange-900" },
  { id: 2, sub: "Ninja Arena", title: "TOP-TIER PVP", img: "/2.jpg", tint: "from-rose-700 to-purple-950" },
  { id: 3, sub: "Admin by your side", title: "DEDICATED SUPPORT", img: "/3.jpg", tint: "from-yellow-500 to-amber-800" },
  { id: 4, sub: "Grind hard", title: "VIP TO THE TOP", img: "/4.jpg", tint: "from-orange-600 to-red-900" },
  { id: 5, sub: "Log in daily", title: "NEWCOMER GIFTS", img: "/5.jpg", tint: "from-emerald-600 to-teal-900" },
  { id: 6, sub: "Hot events", title: "RANK FOR REWARDS", img: "/6.jpg", tint: "from-fuchsia-600 to-violet-950" },
];
